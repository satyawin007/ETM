		...
		<div class="widget-box col-xs-12">
			<div class="widget-header">
				...
				<div style="float:right;padding-right: 2%; margin-top: 1%">
					<a style="color: grey;" href="masters" title="masters"><span style="color:grey"><i class="ace-icon fa fa-home bigger-200"></i></span></a> &nbsp; &nbsp;
					<a style="color: grey;"  title="{{$form_info['back_url']}}" href="{{$form_info['back_url']}}"><span style="color:grey"><i class="ace-icon fa fa-arrow-circle-left bigger-200"></i></span></a>
					<?php if(isset($form_info["addlink"])){ ?>
					    &nbsp;&nbsp;&nbsp;&nbsp;<a style="color: grey;"  title="{{$form_info['addlink']}}"  data-toggle='modal' href="#{{$form_info['addlink']}}"><span style="color:grey"><i class="ace-icon fa fa-plus-circle bigger-200"></i></span></a>					    
					<?php } ?>
				</div>
			</div>
